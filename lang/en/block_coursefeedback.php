...
$string['delete_survey_responses_confirm'] = 'Are you sure you want to delete responses from <strong>{$a->num}</strong> users to the survey in the course <q><strong>{$a->coursename}</strong></q>? This cannot be undone.';
...
$string['event_intro'] = 'Please rate the event <q><strong>{$a}</strong></q>.';
...
$string['isevaluationteacher'] = 'Is a teacher for the course. Can, depending on the organization settings, edit survey settings and period.';
