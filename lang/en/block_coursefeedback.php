...
$string['answers_section_help'] = 'Configure the possible answers to this question here. The languages are configured in the survey settings. All answers should be translated to all languages before the survey is activated.';
...
$string['course_settings'] = 'Survey settings: {$a->fullname}';
$string['course_settings_node'] = 'Survey settings';
$string['coursecategories'] = 'Course categories';
$string['coursefeedback:addinstance'] = 'Add instance of block_coursefeedback';
$string['coursefeedback:changecoursesettings'] = 'Change the survey settings for a course, except for the survey period.';
$string['coursefeedback:changecoursesurveyperiod'] = 'Change the survey period for a course from the default.';
...
$string['coursefeedback:managesurveysglobally'] = 'Administrate surveys globally';
...
$string['new_surveypart'] = 'New survey';
$string['no_answer_option_text'] = 'Text for the "n/a" option';
$string['no_scale_selected'] = 'Please select a scale';
$string['no_survey_execution'] = 'This course is not part of any survey execution.';
...
$string['survey_languages_help'] = 'Select the languages in which the survey should be available. When adding and editing questions, there will be inputs for these languages, and it will be checked if all questions have translations into all of these languages. Only languages installed in {$a->sitename} will be available here.';
